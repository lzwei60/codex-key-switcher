...
`v1.0.2` is the current stable release. The GitHub Release tag should be `v1.0.2`; the application and installer version should be `1.0.2`.

Required release assets:

- `Codex-Key-Switcher-1.0.2-arm64.dmg` for macOS Apple Silicon.
- `Codex-Key-Switcher-1.0.2-x64.dmg` for macOS Intel.
- `Codex-Key-Switcher-Setup-1.0.2-x64.exe` for Windows x64.
