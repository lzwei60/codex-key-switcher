...
`v1.0.5` is the current stable release. The GitHub Release tag should be `v1.0.5`; the application and installer version should be `1.0.5`.

Required release assets:

- `Codex-Key-Switcher-1.0.5-arm64.dmg` for macOS Apple Silicon.
- `Codex-Key-Switcher-1.0.5-x64.dmg` for macOS Intel.
- `Codex-Key-Switcher-Setup-1.0.5-x64.exe` for Windows x64.
- `Codex-Key-Switcher-1.0.5-x86_64.AppImage` and `Codex-Key-Switcher-1.0.5-amd64.deb` for Linux x64.
